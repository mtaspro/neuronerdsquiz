// Chorcha Question Extractor (NEW Layout) - script string for the Admin Dashboard "Copy Script" button.
// This is the exact same script as the root chorcha2-extractor.js bookmarklet.
// It extracts question, options, correct answer, explanation (when unlocked)
// AND the exam reference tag (e.g. "DCU A 24-25") from the new Chorcha review page.
// String.raw is used so the backslashes (regexes, \n) survive as-is in the pasted script.

export const chorcha2Script = String.raw`javascript:(function () {
