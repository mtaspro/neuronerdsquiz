        ...
        <div className="flex justify-between h-14 items-center">
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden lg:flex lg:space-x-4">
              ...
              {(isAdmin || isSuperAdmin) && activeBattleRoom && activeBattleRoom.status === 'started' && (
                <button
                  onClick={handleEndBattle}
                  className="text-red-600 dark:text-red-400 font-semibold hover:text-red-800 dark:hover:text-red-300 transition"
                >
                  End Battle
                </button>
              )}
          ...
          <div className="absolute top-14 right-0 w-80 max-w-sm bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 shadow-lg h-full" onClick={(e) => e.stopPropagation()}>
            <div className="p-4">
              <div className="space-y-2">
                ...
                {(isAdmin || isSuperAdmin) && activeBattleRoom && activeBattleRoom.status === 'started' && (
                  <button
                    onClick={() => { handleEndBattle(); setMenuOpen(false); }}
                    className="block px-3 py-2 rounded-md text-base font-semibold text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/20 transition w-full text-left"
                  >
                    End Battle
                  </button>
                )}
